...
class Test_DateEndInvalid {
    ...
    @DisplayName("api/v1/access_change-master-user -> 400 Bad Request: Invalid DateEnd")
    @AllureId("184903")
    fun test() {
        checkBR(
            ...
            expected = setOf(BrokenRule(code = 12, message = "DateEnd is invalid."))
        )
    }
}