...
class Test_SubscribeIdNull {
    ...
    @DisplayName("/api/v1/access-ids_get-by-subscribe-ids -> 400 Bad Request: subscribeIds null")
    @AllureId("200506")
    fun test() {
        checkBR(
            apiClient = accessesCrmClient,
            request = AccessesRequests.accessIdsGetBySubscribeIds(null),
            expected = setOf(
                BrokenRule(
                    code = 105,
