...
class Test_OpportunityA360CanCreateByWrongContactIdNegative {
    ...
    @DisplayName("/api/v1/opportunity-a360_can-create -> 400 Bad Request: не валидный contactId")
    @AllureId("145895")
    fun test_OpportunityA360CanCreateByWrongContactIdNegative() {
        checkBR(
            apiClient = supportsCrmClient,
            request = opportunityA360CanCreate(OpportunityA360CanCreateRequest(contactId = "123-123-321-321-222")),
