...
class Test_MultiAccessStatisticGetByAccessIdWrongParamNegative {

    private val request by lazy {
        AccessesRequests.multiAccessStatisticGetByAccessId(
            MultiAccessStatisticGetByAccessIdRequest(accessId = "!@#[,,[]")
    ...
    @DisplayName("/api/v1/multiaccess-statistic_get-by-accessid -> 400 Bad Request: некорректный accessId")
    @AllureId("145344")
    fun test_MultiAccessStatisticGetByAccessIdWrongParamNegative() {
        assertThat(
