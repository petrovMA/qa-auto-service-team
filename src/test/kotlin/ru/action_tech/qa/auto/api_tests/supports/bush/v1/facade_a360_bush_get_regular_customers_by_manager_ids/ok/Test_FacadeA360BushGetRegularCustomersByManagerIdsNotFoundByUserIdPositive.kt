...
class Test_FacadeA360BushGetRegularCustomersByManagerIdsNotFoundByUserIdPositive {

    private val request by lazy {
        facadeA360BushGetRegularCustomersByManagerIds(
            FacadeA360BushGetRegularCustomersByManagerIdsRequest(
                systemUserIds = listOf(ZERO_ID),
    ...
    @DisplayName("/api/v1/facade-a360-bush_get-regular-customers-by-manager-ids -> 200 Ok: ничего не найдено по systemUserIds")
    @AllureId("145880")
    fun test_FacadeA360BushGetRegularCustomersByManagerIdsNotFoundByUserIdPositive() {
