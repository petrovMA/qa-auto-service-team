...
import ru.action_tech.qa.auto.data.SupportStatus.SUPPORT_STATUS_11
import ru.action_tech.qa.auto.data.SupportType.SUPPORT_TYPE_1
...
class Test_SupportsEndDateMax {
    ...
    @DisplayName("/api/v1/supports_get-for-order -> 200 Ok: Получить сопровождения с endDate = ${FieldData.MAX_DATE}")
    @Test
    @AllureId("243611")
    fun test() {
