...
class Test_FacadeA360BushManagersLimitsGetByIdsNoParams {
    ...
    @DisplayName("/api/v1/facade-a360-bush-managers-limits_get-by-ids -> 400 Bad Request: Запрос без параметров")
    @AllureId("194125")
    fun test() {
        checkBR(
            apiClient = supportsCrmClient,
            request = facadeA360BushManagersLimitsGetByIds(null),
