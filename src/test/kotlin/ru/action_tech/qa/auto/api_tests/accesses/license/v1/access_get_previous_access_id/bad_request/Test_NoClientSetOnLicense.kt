...
class Test_NoClientSetOnLicense {
    ...
    @DisplayName("/api/v1/access_get-previous-access-id -> 400 Bad Request: на доступе не задан клиент (лицензия)")
    @AllureId("145310")
    fun test() {
        checkBR(
            apiClient = accessesCrmClient,
            request = AccessesRequests.accessesGetPreviousAccessId(accessId = "5DA02996-95A1-4174-9483-DA066E99667D", userId = null),
