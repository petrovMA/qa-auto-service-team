...
class Test_Action360AccessForAccountNilUuid {
    ...
    @DisplayName("/api/v1/aktion360-access-for-account_validate -> 400 Bad Request: передан nil uuid")
    @AllureId("154454")
    fun test() {
        checkBR(
            apiClient = accessesCrmClient,
            request = AccessesRequests.action360AccessForAccountValidate(accountId = "00000000-0000-0000-0000-000000000000"),
