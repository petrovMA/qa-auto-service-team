...
class Test_FacadeA360BushUpdateRegularCustomersWrongAuthorId {
    ...
    @DisplayName("/api/v1/facade-a360-bush-managers-limits_update -> 400 Bad Request: wrong format AuthorId")
    @AllureId("198101")
    fun test() {
        checkBR(
