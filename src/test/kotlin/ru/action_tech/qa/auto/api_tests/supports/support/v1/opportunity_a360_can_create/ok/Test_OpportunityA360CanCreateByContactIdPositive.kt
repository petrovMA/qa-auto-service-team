...
class Test_OpportunityA360CanCreateByContactIdPositive {

    private val request by lazy {
        opportunityA360CanCreate(OpportunityA360CanCreateRequest(contactId = "97FB554F-26E1-44CF-AECD-051F8DEA3776"))
    }
    ...
    @Response_200_Ok
    @DisplayName("/api/v1/opportunity-a360_can-create -> 200 Ok: Проверка организации на наличие сопровождения с возможной сделкой Актион 360 (contactId запрос)")
    @AllureId("145898")
    fun test_OpportunityA360CanCreateByContactIdPositive() {
