...
class Test_OpportunityA360GetByBushAction360SupportStatusesPositive {
    ...
    @DisplayName("/api/v1/opportunity-a360_get-by-bush-action360-support-statuses -> 200 Ok: Получить сопровождения с возможной сделкой Актион 360, отменённая сделка статус 124")
    @AllureId("145901")
    fun test() {
