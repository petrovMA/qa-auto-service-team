...
class Test_OrdersGetToCreateLogentriesBatchNoProductIds {
    ...
    @DisplayName("/orders_get-to-create-logentries-batch-by-product-ids-by-customer-id -> 400 Bad Request: не передан параметр productIds")
    @AllureId("177648")
    fun test() {
        checkBR(
