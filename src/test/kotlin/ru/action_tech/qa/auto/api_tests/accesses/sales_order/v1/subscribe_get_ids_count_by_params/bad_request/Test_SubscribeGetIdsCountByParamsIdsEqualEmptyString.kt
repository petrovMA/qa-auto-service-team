...
class Test_SubscribeGetIdsCountByParamsIdsEqualEmptyString {

    @Test
    @Sale_Accesses
    @HistoryIssues("ARMAP-15523")
    @SubscribeGetIdsCountByParamsV1
    @Response_400_Bad_Request
    @Requirements("REQCRM-1647")
    @DisplayName("/api/v1/subscribe_get-ids-count-by-params -> 200 Ok: пустая строка в массиве")
    @AllureId("177464")
    fun test() {
        checkBR(
