...
class Test_OrdersGetToCreateLogentriesBatchByProductIdsNoProductIds {
    ...
    @DisplayName("/orders_get-to-create-logentries-batch-by-product-ids -> 400 Bad Request: не передан параметр productIds")
    @AllureId("177741")
    fun test() {
        checkBR(
