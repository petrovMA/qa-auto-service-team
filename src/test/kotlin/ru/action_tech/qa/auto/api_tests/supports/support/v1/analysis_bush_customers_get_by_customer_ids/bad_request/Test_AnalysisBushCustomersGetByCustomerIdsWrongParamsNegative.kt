...
class Test_AnalysisBushCustomersGetByCustomerIdsWrongParamsNegative {
    ...
    @DisplayName("/api/v1/analysis-bush-customers_get-by-customer-ids -> 400 Bad Request: нет параметра paymentScenarioId")
    @AllureId("177261")
    fun test() {
        checkBR(
            apiClient = supportsCrmClient,
            request = analysisBushCustomersGetByCustomerIds(customerIds = listOf("123", "qwe", "=-_")),
