package ru.action_tech.qa.auto.api_tests.supports.support.v1.analysis_bush_customers_count_get_by_customer_ids.ok
...
class Test_AnalysisBushCustomersCountGetByCustomerIdsPositive {
    ...
    @Response_200_Ok
    @DisplayName("/api/v1/analysis-bush-customers-count_get-by-customer-ids -> 200 Ok: Вернулся список типов договоров")
    @AllureId("177315")
    fun test_ListOfTypes() {
        val response = supportsCrmClient.send(analysisBushCustomersCountGetByCustomerIds(customerIds))
