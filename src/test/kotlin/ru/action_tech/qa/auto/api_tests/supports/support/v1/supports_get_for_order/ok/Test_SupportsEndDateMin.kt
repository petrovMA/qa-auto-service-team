...
class Test_SupportsEndDateMin {
    ...
    @AllureId("242630")
    @DisplayName("/api/v1/supports_get-for-order -> 200 Ok: Получить сопровождения с endDate = ${FieldData.MIN_DATE}")
    fun test() {
