package ru.action_tech.qa.auto.api_models.accesses.storage.v1.access_cancel

data class AccessCancelResponse(
    ...
    data class Activation(val activationInterval: String?, val activationType: String?, val interval: Int?)
