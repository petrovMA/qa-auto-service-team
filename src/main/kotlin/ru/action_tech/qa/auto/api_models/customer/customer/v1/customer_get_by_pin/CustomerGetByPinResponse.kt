package ru.action_tech.qa.auto.api_models.customer.customer.v1.customer_get_by_pin

data class CustomerGetByPinResponse(
    val bitrixId: String?,
    ...
    data class ContactInfo(
        ...
        data class ValidationStatuses(val status: Int, val additionalInfo: String?)
    }
}